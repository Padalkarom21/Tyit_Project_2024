...
#define INTRUTION_BUTTON 14
#define BUZZER_PIN 15

//======================================== Insert your network credentials.
const char* ssid = "NOTHING";
const char* password = "gayatri25";
//======================================== 
...
String serverName = "192.168.112.128";  //--> Change with your server computer's IP address or your Domain name.
// The file path "upload_img.php" on the server folder.
String serverPath = "/ESP32CAM-2/upload_img.php";
// Server Port.
...
int pir_sensor_state = 0;         // variable for reading the pushbutton status
int intrution_button_state = 1;
...
void setup() {
  ...
  pinMode(INTRUTION_BUTTON, INPUT);
...
void loop() {
  ...
  intrution_button_state = digitalRead(INTRUTION_BUTTON);
  
  // Check if PIR sensor senses any motion OR intrution button is pressed
  if (pir_sensor_state == HIGH || intrution_button_state == LOW) 
  {
    sendPhotoToServer();
    delay(200);
    digitalWrite(BUZZER_PIN,HIGH);
